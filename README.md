...
Если публичный IP не удалось определить автоматически, в выводе будет заглушка, и ссылку нужно собрать с вашим реальным публичным IP вручную.
...
В конце обычной установки скрипт дополнительно предлагает ввести adtag сразу, если он уже получен. Если тега ещё нет, этот шаг можно пропустить и вернуться к нему позже.
